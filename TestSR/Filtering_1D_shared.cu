...
//----------------------------------------------------------------------------------------------------------
__device__ void Filtering_1D_vertical_shared_dev(float *inputImageKernel, float *outputImagekernel, int imageWidth, int imageHeight, float *pKernel, int iKernelSize, int row, int col)
{
...
//----------------------------------------------------------------------------------------------------------
__device__ void Filtering_1D_horizontal_shared_dev(float *inputImageKernel, float *outputImagekernel, int imageWidth, int imageHeight, float *pKernel, int iKernelSize, int row, int col)
{
	unsigned int iOffset = row * imageWidth + col;
	float sum = 0;
	int iWin = iKernelSize / 2;
...
//-------------------------------------------------------------------
__global__ void Filtering_1D_shared_Kernel(float *inputImageKernel, float *outputImagekernel, int imageWidth, int imageHeight, float *pKernel_g, int iKernelSize, int dir)

{
	...
	{
		Filtering_1D_horizontal_shared_dev(inputImageKernel, outputImagekernel, imageWidth, imageHeight, pKernel, iKernelSize, row, col);

	}
	else
	{
		Filtering_1D_vertical_shared_dev(inputImageKernel, outputImagekernel, imageWidth, imageHeight, pKernel, iKernelSize, row, col);
	}
...
cudaError_t Filtering_1D_shared_Cuda(float *pInData, float *pOutData, int iWidth, int iHeight, float *pKernel, int iKernelSize, int dir)
{
	...
	Filtering_1D_shared_Kernel << <dimGrid, dimBlock >> > (d_InData, d_OutData, iWidth, iHeight, d_pKernel, iKernelSize, dir);
